...
void GrimReaper::Init(Vec2 playerpos)
{

	ChangeVolumeSoundMem(80, hitsound_);
...
void GrimReaper::Update(Vec2 playerpos)
{
...
void GrimReaper::Draw(bool charactervector, Vec2 playerpos)
{
...
void GrimReaper::SetData(int hitsound)
{
	hitsound_ = hitsound;
}

void GrimReaper::PlayerMove(Vec2 playermove)
{
...
void GrimReaper::Damage(int attackpoint, int attacknumber)
{
...
void GrimReaper::SetCoolDownTime()
{
...
bool GrimReaper::CheckHit(Vec2 minhitbox1, Vec2 maxhitbox1, Vec2 minhitbox2, Vec2 maxhitbox2)
{
...
void GrimReaper::EnemyLvUp(int level)
{
	level_ = level;
	nowhp_ *= level;
	if (level_ >= 4) {
...
void GrimReaper::ChangeExp(Vec2 pos)
{
